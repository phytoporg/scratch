...
bool LoadContent()
{
    ...
    g_d3dVertexShader = LoadShader<ID3D11VertexShader>(
        L"../SimpleVertexShader.hlsl", "SimpleVertexShader", "latest", &pVertexShaderBlob);
    ID3DBlob* pPixelShaderBlob;
    g_d3dPixelShader = LoadShader<ID3D11PixelShader>(
        L"../SimplePixelShader.hlsl", "SimplePixelShader", "latest", &pPixelShaderBlob);
